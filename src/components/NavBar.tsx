        ...
        <nav className={styles.navBarWrapper}>
            ...
            <div className={styles.links}>
                ...
                <button className={styles.searchButton}>
                    <svg width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#a5afb9" stroke-miterlimit="10"><circle cx="10.389" cy="10.388" r="7.395" stroke-width="2.032"></circle><path d="m15.64 15.638 5.517 5.517" stroke-linecap="round" stroke-width="2.001"></path></g></svg>
